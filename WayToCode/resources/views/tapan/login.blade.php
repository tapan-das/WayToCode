    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('public/login/images/bg-01.jpg');">
            <div class="wrap-login100">
                ...
                <form method="POST" action="{{ route('login.tapan') }}">
                        @csrf
                    ...
                    <!--<div class="wrap-input100 validate-input" data-validate = "Enter username">
                        ...
                        <span class="focus-input100" data-placeholder="&#xf207;"></span>
                            ...
                            <div class="wrap-input100 validate-input" data-validate = "Enter Email">
                                <input id="email" type="email" class="input100" name="email" placeholder="Enter Email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                <span class="focus-input100" data-placeholder="&#xf207;"></span>
                            </div>
                    ...
                    <!--<div class="wrap-input100 validate-input" data-validate="Enter password">
                        ...
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Enter password">
                                <input id="password" type="password" class="input100" name="password" placeholder="Enter Password" required autocomplete="current-password">
                                <span class="focus-input100" data-placeholder="&#xf191;"></span>
                            </div>
